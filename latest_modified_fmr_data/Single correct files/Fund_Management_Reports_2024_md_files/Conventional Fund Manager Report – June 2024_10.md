...
Alfalah Asset Management Limited (formerly Alfalah GHP Investment Management Limited) Fund Managers' Report June 2024
...
| Fund Size (PkR mn; as on June 30, 2024)           | 1,394.0 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,394.0 |
| NAV (PkR):                                        | 100.11  |
| Wtd. Average Maturity (Years):                    | 3.53    |
| Total Expense Ratio(YTD)\*                        | 1.25%   |
| Total Expense Ratio(Month)                        | 1.24%   |

## Fund Performance

| Period                 | BM     | ASRF-9 |
| ---------------------- | ------ | ------ |
| Since Inception Return | 20.35% | 20.84% |
| YTD                    | 20.35% | 20.84% |
| Month (June, 2024)     | 19.73% | 18.95% |
...
\*This include 0.981% representing government levy and SECP Fee

\*\*Actual Management fee charge 0.75% of net assets

Selling & marketing expense - for the period ended June,2024, PKR Mn 0.095
...
| Fund Size (PkR mn; as on June 30, 2024)           | 551.8  |
| ------------------------------------------------- | ------ |
| Fund size including fund of fund schemes (PkR mn) | 551.8  |
| NAV (PkR):                                        | 100.33 |
| Wtd. Average Maturity (Years):                    | 0.37   |
...
| Period                 | BM     | ASRF-10 |
| ---------------------- | ------ | ------- |
| Since Inception Return | 20.35% | 21.26%  |
| YTD                    | 20.35% | 21.26%  |
| Month (June, 2024)     | 19.73% | 23.61%  |
...
\*This include 0.768% representing government levy and SECP Fee

\*\*Actual Management fee charge 0.75% of net assets

Selling & marketing expense - for the period ended June,2024, PKR Mn 0.135
...
| Fund Size (PkR mn; as on June 30, 2024)           | 1,300.1 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,300.1 |
| NAV (PkR):                                        | 100.33  |
...
|                        | BM     | ASRF-11 |
| ---------------------- | ------ | ------- |
| Since Inception Return | 20.41% | 18.32%  |
| YTD                    | 20.41% | 18.32%  |
| Month (June, 2024):    | 19.73% | 23.00%  |

## Credit Quality (as % of Total Assets)

| Credit Quality               | Percentage |
| ---------------------------- | ---------- |
| Govt. Securities (Rated AAA) | 99.48%     |
| A                            | 0.00%      |
| AAA                          | 0.26%      |
| A-                           | 0.00%      |
| AA+                          | 0.00%      |
...
Selling & marketing expense - for the period ended June,2024, PKR Mn 0.294
...
| Equity       | 80.69%  | 81.07%  |
| Income       | 13.67%  | 13.46%  |
| Money Market | 3.95%   | 3.88%   |
| Others       | 0.98%   | 0.95%   |
| Total        | 100.00% | 100.00% |

### Fund Statistic:s

| Fund Size (PkR mn)          | 72.61   |
| --------------------------- | ------- |
| NAV (PkR)                   | 93.1878 |
...
|                              | BM     | AGAAP  |
| ---------------------------- | ------ | ------ |
| Since Inception Return**\*** | 11.98% | 9.28%  |
| YTD                          | 61.39% | 57.42% |
| Month                        | 3.17%  | 3.46%  |
...
| ------------ | ------- | ------- | ------------------------ |
| Cash         | 0.95%   | 1.19%   | \*\* 3 Star              |
| Equity       | 28.79%  | 29.14%  | \*\* 2 Star              |
| Income       | 65.44%  | 64.94%  | AA                       |
| Money Market | 0.57%   | 0.56%   | AA-                      |
| Others       | 4.23%   | 4.17%   | A+                       |
| Total        | 100.00% | 100.00% | NR/UR                    |

### Fund Statistic:s

| Fund Size (PkR mn)          | 35.29   |
| --------------------------- | ------- |
| NAV (PkR)                   | 98.8174 |
...
|                              | BM     | AGMAP  |
| ---------------------------- | ------ | ------ |
| Since Inception Return**\*** | 12.07% | 9.70%  |
| YTD                          | 41.00% | 40.59% |
| Month                        | 2.23%  | 2.71%  |
...
| Equity       | 16.28% | 16.59%  |
| Income       | 28.71% | 36.09%  |
| Money Market | 46.59% | 46.43%  |
| Others       | 0.78%  | 0.76%   |
| Total        | 92.56% | 100.00% |

### Fund Statistic:s

| Fund Size (PkR mn)          | 268.13   |
| --------------------------- | -------- |
| NAV (PkR)                   | 108.4069 |
...
|                              | BM     | AGCAP  |
| ---------------------------- | ------ | ------ |
| Since Inception Return**\*** | 11.95% | 10.28% |
| YTD                          | 31.92% | 34.12% |
| Month                        | 1.95%  | 6.02%  |
...
| Equity       | 0.00% | 12.14%  |
| Income       | 0.00% | 4.43%   |
| Money Market | 0.00% | 82.80%  |
| Others       | 0.00% | 0.12%   |
| Total        | 0.00% | 100.00% |

### Fund Statistic:s

| Fund Size (PkR mn)          | 420.80                   |
| --------------------------- | ------------------------ |
| NAV (PkR)                   | 100.0591                 |
| Cash Percentage             | May: 2.61%, June: 0.52%  |
| Equity Percentage           | May: 0.00%, June: 12.14% |
...
|                              | BM    | AGCPP-4 |
| ---------------------------- | ----- | ------- |
| Since Inception Return**\*** | 2.76% | 2.76%   |
| YTD                          | 2.76% | 2.76%   |
| Month                        | 1.89% | 1.98%   |
...
\*\*AGAAP: This include 0.0660% representing government levy and SECP Fee

\*\*\*AGMAP: This include 0.0610% representing government levy and SECP Fee

\*\*\*\*AGCAP: This include 0.0260% representing government levy and SECP Fee
...
\*\*\*\*AGCPP4: This include 0.0000% representing government levy and SECP Fee
...
| Min. Subsequent Investment | PKR 1000/-                    |
| Trustee                    | CDC Pakistan Limited          |
| Auditor                    | A.F. Ferguson & Co            |
| Cut-off Time               | 9:00 am - 4:00 pm             |
| Dealing Days               | Monday - Friday               |
...
| Fund Size (PKR Mn.) | NAV     | Year To Date Return | Since Inception Return\* | Expense ratio (month) | Expense ratio (YTD)\*\*\* |
| ------------------- | ------- | ------------------- | ------------------------ | --------------------- | ------------------------- |
| 33.9142             | 111.169 | 20.49%              | 20.49%                   | 0.72%                 | 0.71%                     |

## Alfalah KPK Money Market Sub Fund (Monthly Return)
...
**\***AKPKMMSF: This includes 0.3040% representing government levy and SECP Fee
...
| Company                          | Percentage |
| -------------------------------- | ---------- |
| The Hub Power Company Limited    | 7.26%      |
| Fauji Fertilizer Company Limited | 4.48%      |
| Sazgar Engineering Works Limited | 4.46%      |
| United Bank Limited              | 4.21%      |
| Bank AL Habib Limited            | 3.83%      |
| Pakistan Petroleum Limited       | 3.44%      |
| Mari Petroleum Company Limited   | 3.40%      |
| Meezan Bank Limited              | 3.24%      |
| Lucky Cement Limited             | 3.11%      |
| Cherat Cement Company Limited    | 2.97%      |
...
| Fund Size (PKR Mn.)    | 85.11  |
| ---------------------- | ------ |
| NAV (PKR)              | 154.31 |
| Year To Date Return    | 96.89% |
| Since Inception Return | 5.96%  |
| Expense Ratio (Month)  | -8.66% |
...
| Fund Size (PKR Mn.)    | 81.995 |
| ---------------------- | ------ |
| NAV (PKR)              | 194.09 |
| Year To Date Return    | 19.43% |
| Since Inception Return | 9.25%  |
...
\*\*\*AGESF: This includes 0.2040% representing government levy and SECP Fee

\*\*\*\*AGDSF: This includes 0.1350% representing government levy and SECP Fee

**\***AGMMSF: This includes 0.1290% representing government levy and SECP Fee

Selling & marketing expense - for the period ended June,2024
