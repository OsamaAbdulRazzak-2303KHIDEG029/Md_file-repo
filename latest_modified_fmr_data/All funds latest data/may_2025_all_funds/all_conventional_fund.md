...
# Alfalah Asset Management Limited Fund Managers' Report May 2025
...
Looking ahead, while the disinflation trend provides a favorable backdrop for bond investors, the scope for further rate cuts will likely hinge on the central bank’s comfort with foreign exchange reserve buffers. For fixed income investors, the current environment suggests potential for capital gains, particularly at the mid-to-long end of the yield curve, provided macro stability is sustained.
...
| Fund Size (PkR mn; as on May 31, 2025)            | 7,152.4 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 7,152.4 |
| NAV (PkR)                                         | 116.3   |
| Wtd. Average Maturity (Days)                      | 39.94   |
...
| ------------------------ | ------ | -------- |
| Since Inception Return\* | 14.40% | 15.05%   |
| YTD                      | 14.13% | 14.62%   |
| Month (May 2025)         | 11.19% | 12.81%   |

Avg. Peer Group Return for May 2025 was 11.58%
5 years Peer Group Average Returns for May 2025 was 14.41%
...
Aim to generate competitive returns with minimum risk and enhanced liquidity by investing primarily in short-term government securities, term deposits, and money market instruments with a weighted average time to maturity of Net Assets not exceeding 90 days.
...
| Fund Size (PkR mn; as on May 31, 2025)            | 986.8 |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 986.8 |
| NAV (PkR)                                         | 116.9 |
| Wtd. Average Maturity (Days)                      | 42.2  |
...
| ------------------------ | ------ | ------- |
| Since Inception Return\* | 9.32%  | 10.45%  |
| YTD                      | 14.13% | 14.53%  |
| Month (May 2025)         | 11.19% | 11.99%  |
...
| Credit Rating                | Percentage | Credit Rating | Percentage |
| ---------------------------- | ---------- | ------------- | ---------- |
| Govt. Securities (Rated AAA) | 96.56%     | A1+           | 0.00%      |
| AAA                          | 0.26%      | A1            | 0.00%      |
| AA+                          | 0.00%      | A-            | 0.00%      |
| AA                           | 1.54%      | BBB+          | 0.00%      |
| AA-                          | 0.00%      | BBB           | 0.00%      |
...
\*\*This includes 0.130% representing government levy and SECP Fee
...
| Fund Size (PkR mn; as on May 31, 2025)            | 79.1  |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 79.1  |
| NAV (PkR)                                         | 118.4 |
| Wtd. Average Maturity (Days)                      | 0.0   |
| Total Expense Ratio (YTD)\*\*                     | 2.76% |
| Total Expense Ratio (Month)                       | 2.35% |

Fund Performance

| Fund Performance         | BM     | AIGF    |
| ------------------------ | ------ | ------- |
| Since Inception Return\* | 11.63% | 10.55%  |
| YTD                      | 14.00% | 9.03%   |
| Month (May 2025)         | 11.84% | -13.91% |

Avg. Peer Group Return for May 2025 was 18.67%

5 years Peer Group Average Returns for May 2025 was 16.50%
...
| ----------------- | ---- | ------------------------- | ------------------------- | ------------------------ | ---------------- | ---------------- |
| Minimum Fund Size | -    | -                         | -                         | -                        | 79,093,566       | 100,000,000      |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 860.0 |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 860.0 |
| NAV (PkR)                                         | 115.5 |
...
| ------------------------ | ------ | ------ |
| Since Inception Return\* | 11.76% | 11.62% |
| YTD                      | 14.05% | 12.68% |
| Month (May 2025)         | 11.12% | 11.90% |

Avg. Peer Group Return for May 2025 was 15.08%

5 years Peer Group Average Returns for May 2025 was 14.03%

Credit Quality (as % of Total Assets)

| Rating                       | Value  | Rating | Value  |
| ---------------------------- | ------ | ------ | ------ |
| Govt. Securities (Rated AAA) | 28.54% | A1+    | 0.00%  |
| AAA                          | 0.15%  | A1     | 0.00%  |
| AA+                          | 0.00%  | A-     | 0.00%  |
| AA                           | 2.58%  | BBB+   | 0.00%  |
| AA-                          | 25.86% | BBB    | 0.00%  |
...
\*\*This includes 0.140% representing government levy and SECP Fee
...
| Fund Size (PkR mn; as on May 31, 2025)            | 186.2 |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 186.2 |
| NAV (PkR)                                         | 113.7 |
...
| ------------------------ | ------ | ------ |
| Since Inception Return\* | 11.04% | 10.51% |
| YTD                      | 14.05% | 12.54% |
| Month (May 2025)         | 11.12% | 11.19% |
...
| Rating                 | Value  | Rating | Value  |
| ---------------------- | ------ | ------ | ------ |
| Govt. Securities (AAA) | 0.00%  | A1+    | 0.00%  |
| AAA                    | 0.78%  | A1     | 0.00%  |
| AA+                    | 0.01%  | A-     | 0.00%  |
| AA                     | 0.02%  | BBB+   | 0.00%  |
| AA-                    | 34.26% | BBB    | 0.00%  |
...
| Fund Size (PKR mn; May 2025)                      | 340.74 |
| ------------------------------------------------- | ------ |
...
| ------------------- | ------ | ------ |
| Since Inception\*\* | 8.89%  | 11.64% |
| YTD                 | 32.72% | 45.11% |
| Month - April 2025  | 6.57%  | 6.03%  |
...
| Holding                               | Percentage |
| ------------------------------------- | ---------- |
| Fauji Fertilizer Company Limited      | 7.36%      |
| United Bank Limited                   | 5.10%      |
| MCB Bank Limited                      | 4.07%      |
| Oil & Gas Development Company Limited | 3.98%      |
| Lucky Cement Limited                  | 3.91%      |
| Pakistan Petroleum Limited            | 3.29%      |
| Cherat Cement Company Limited         | 3.18%      |
| Bank AL Habib Limited                 | 2.67%      |
| Sazgar Engineering Works Limited      | 2.56%      |
| Pakistan State Oil Company Limited    | 2.54%      |
...
- Calculated on 12-month trailing data.
  ** Since Inception return is calculated on Compound Annual Growth Rate (CAGR). \*** This includes 0.6600% representing government levy and SECP Fee. \***\* Actual Management fee charged: 3.44% of net assets.
...
| Fund Size (PkR mn; as on May 31, 2025)            | 184.7  |
| ------------------------------------------------- | ------ |
| Fund size including fund of fund schemes (PkR mn) | 184.7  |
| NAV (PkR)                                         | 125.05 |
...
| ------------------------ | ------ | ------ |
| Since Inception Return\* | 11.37% | 10.88% |
| YTD                      | 14.05% | 21.51% |
| Month (May 2025)         | 11.12% | 17.76% |
...
| Credit Rating                | Percentage | Credit Rating | Percentage |
| ---------------------------- | ---------- | ------------- | ---------- |
| Govt. Securities (Rated AAA) | 92.73%     | A1+           | 0.00%      |
| AAA                          | 0.06%      | A1            | 0.00%      |
| AA+                          | 0.01%      | A-            | 0.00%      |
| AA                           | 0.39%      | BBB+          | 0.00%      |
| AA-                          | 1.53%      | BBB           | 0.00%      |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 2,728.5 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 2,728.5 |
| NAV (PkR)                                         | 145.8   |
| Wtd. Average Maturity (Years)                     | 1.8     |
| Total Expense Ratio (YTD)\*\*                     | 1.04%   |
| Total Expense Ratio (Month)                       | 1.11%   |

Fund Performance

| Fund Performance         | BM     | AGSF - III |
| ------------------------ | ------ | ---------- |
| Since Inception Return\* | 14.00% | 12.54%     |
| YTD                      | 13.82% | 17.10%     |
| Month (May 2025)         | 11.22% | 24.27%     |
...
| ---------------------------- | ---------- | ------ | ---------- |
| Govt. Securities (Rated AAA) | 98.23%     | A1+    | 0.00%      |
| AAA                          | 0.00%      | A1     | 0.00%      |
| AA+                          | 0.00%      | A-     | 0.00%      |
| AA                           | 0.71%      | BBB+   | 0.00%      |
| AA-                          | 0.16%      | BBB    | 0.00%      |
...
\*\*\* Actual Management fee charged: 1.32% of net assets
Selling & marketing expense - for the period ended May, 2025, PKR Mn 0.000
...
| Fund Size (PKR mn; May 2025)                      | 125.97 |
| ------------------------------------------------- | ------ |
| Fund size including fund of fund schemes (PKR mn) | 125.97 |
| NAV (PKR)                                         | 66.16  |
| Total Expense Ratio (YTD)                         | 3.70%  |
...
| ------------------- | ------ | -------- |
| Since Inception\*\* | 16.44% | 6.31%    |
| YTD                 | 52.58% | 63.39%   |
| Month (May 2025)    | 7.51%  | 9.54%    |
...
| Sector                          | Percentage |
| ------------------------------- | ---------- |
| Commercial Banks                | 16.68%     |
| Oil & Gas Marketing Companies   | 11.79%     |
| Oil & Gas Exploration Companies | 11.78%     |
| Vanaspati & Allied Industries   | 8.89%      |
| Automobile Assembler            | 8.04%      |
| Others                          | 36.41%     |
| **Total**                       | **93.60%** |
...
| Holding                               | Percentage |
| ------------------------------------- | ---------- |
| S.S. Oil Mills Limited                | 8.89%      |
| United Bank Limited                   | 8.38%      |
| Oil & Gas Development Company Limited | 5.92%      |
| Pakistan State Oil Company Limited    | 5.01%      |
| MCB Bank Limited                      | 4.67%      |
| Big Bird Foods Limited                | 4.36%      |
| Sui Southern Gas Company Limited      | 3.97%      |
| Sazgar Engineering Works Limited      | 3.70%      |
| Mari Petroleum Company Limited        | 3.47%      |
| Thatta Cement Company Limited         | 3.36%      |
...
\*Calculated on 12-month trailing data.
\*\*Since Inception return is calculated on Compound Annual Growth Rate (CAGR).
\*\*\*This includes 0.4000% representing government levy and SECP Fee.
\*\*\*\*Actual Management fee charged: 2.10% of net assets.
Selling & marketing expense - for the period ended May 2025, PKR Mn 0.000.

# Alfalah Asset Allocation Fund

Fund Stability Rating: "2 Star" by PACRA 22-Oct-24
...
The prime objective of Alfalah Asset Allocation Fund (AAAF) endeavors is to provide investors with an opportunity to earn long-term capital appreciation optimizing through a broad mix of asset classes encompassing equity, fixed income & money market instruments.
...
| Fund Size (PKR mn; May 2025)                      | 164.99 |
| ------------------------------------------------- | ------ |
| Fund Size including fund of fund schemes (PKR mn) | 164.99 |
| NAV (PKR)                                         | 94.23  |
| Total Expense Ratio (YTD)                         | 3.28%  |
| Total Expense Ratio (Month)                       | 4.08%  |

Fund Performance

| Fund Performance   | BM      | AAAF    |
| ------------------ | ------- | ------- |
| Since Inception    | 470.33% | 265.62% |
| YTD                | 44.23%  | 53.06%  |
| Month - April 2025 | 8.85%   | 5.12%   |
...
| Oil & Gas Exploration Companies | 13.91%     |
| Pharmaceuticals                 | 11.30%     |
| Oil & Gas Marketing Companies   | 10.64%     |
| Others                          | 26.44%     |
...
| Fauji Fertilizer Company Limited                 | 8.42%      |
| Haleon Pakistan Limited (Formerly GSKCH Pak Ltd) | 7.84%      |
| Pakistan State Oil Company Limited               | 6.83%      |
| Oil & Gas Development Company Limited            | 6.03%      |
| Lucky Cement Limited                             | 5.19%      |
| Cherat Cement Company Limited                    | 4.96%      |
| Pakistan Petroleum Limited                       | 4.24%      |
| Mari Petroleum Company Limited                   | 3.64%      |
| Sazgar Engineering Works Limited                 | 3.25%      |

Details of Non-Compliant Investments

| Name                   | Type                   | Value before Provisioning | Provisioning | Value after Provisioning | % Gross Assets | % Net Assets |
| ---------------------- | ---------------------- | ------------------------- | ------------ | ------------------------ | -------------- | ------------ |
| Cash & Cash Equivalent | Cash & Cash Equivalent | 9,430,033                 | -            | 9,430,033                | 5.50%          | 5.72%        |
...
\*\*\*This includes 0.4200% representing government levy and SECP Fee.

\*\*\*\*Actual Management fee charged: 3.30% of net assets.

Selling & marketing expenses - for the period ended May, 2025, PKR Mn 0.000.

# Alfalah Financial Value Fund Plan-II
...
| Fund Size (PKR mn; May 2025)                      | 102.53  |
| ------------------------------------------------- | ------- |
| Fund Size including fund of fund schemes (PKR mn) | 102.53  |
| NAV (PKR)                                         | 102.525 |
| Total Expense Ratio (YTD)                         | 2.00%   |
...
| Fund Performance    | BM    | AGFVF |
| ------------------- | ----- | ----- |
| Since Inception\*\* | 3.41% | 2.53% |
| YTD                 | 3.41% | 2.53% |
| Month (May 2025)    | 0.86% | 0.52% |
...
\*\*\*\* Management fee charged: 0.25%
Selling & marketing expenses - for the period ended May 2025, PKR Mn 0.000.

# Alfalah Special Savings Plan-I

Fund Stability Rating: "CP+" by PACRA 22-Oct-24
...
| Fund Size (PkR mn; as on May 31, 2025)            | 54.3  |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 54.3  |
| NAV (PkR)                                         | 141.9 |
| Wtd. Average Maturity (Years)                     | 4.15  |
...
| ------------------------ | ------ | -------- |
| Since Inception Return\* | 16.71% | 12.93%   |
| YTD                      | 13.81% | 5.10%    |
| Month (May 2025)         | 11.29% | 3.47%    |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating | Percentage |
| ---------------------------- | ---------- | ------ | ---------- |
| Govt. Securities (Rated AAA) | 88.94%     | A1+    | 0.00%      |
| AAA                          | 0.00%      | A1     | 0.00%      |
| AA+                          | 0.00%      | A-     | 0.00%      |
| AA                           | 0.11%      | BBB+   | 0.00%      |
| AA-                          | 4.39%      | BBB    | 0.00%      |
...
\*\*This includes 0.090% representing government levy and SECP Fee
...
| Fund Size (PkR mn; as on May 31, 2025)            | 53.2  |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 53.2  |
| NAV (PkR)                                         | 122.4 |
...
| ------------------------ | ------ | --------- |
| Since Inception Return\* | 17.99% | 26.68%    |
| YTD                      | 13.81% | 14.61%    |
| Month (May 2025)         | 11.29% | 3.53%     |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating | Percentage |
| ---------------------------- | ---------- | ------ | ---------- |
| Govt. Securities (Rated AAA) | 90.29%     | A1+    | 0.00%      |
| AAA                          | 0.00%      | A1     | 0.00%      |
| AA+                          | 0.00%      | A-     | 0.00%      |
| AA                           | 0.00%      | BBB+   | 0.00%      |
| AA-                          | 4.93%      | BBB    | 0.00%      |
...
# Investment Plans Summary Report for May 2025 (Alfalah Stable Return Fund Plan)
...
| --------------------------------------------------- | ------------------------------- |
| Date of Launch/IOP                                  |                                 |
| Total Number of Investment Plans (Active & Matured) | 18 (8 Active, 10 Matured)       |
| Cumulative Net Assets (CIS)                         | PKR 31,317,567,453              |
| Risk Profile (CIS)                                  | Low                             |
...
| Expense Type                | Amount         |
| --------------------------- | -------------- |
| Audit Fee                   | PKR 499,672    |
| Shariah Advisory Fee        | -              |
| Rating Fee                  | -              |
| Formation Cost Amortization | -              |
| Other Expenses              | PKR 15,675,230 |

Investment Plans

| Plan Name                     | Start Date | End Date  | Risk Profile | Net Assets (PKR) | Status  |
| ----------------------------- | ---------- | --------- | ------------ | ---------------- | ------- |
...
| Stable Return Fund Plan-XII   | 14-Oct-24  | 05-Sep-25 | Low          | 5,447,074,545    | Active  |
| Stable Return Fund Plan-XIII  | 21-Oct-24  | 11-Jul-25 | Low          | 4,341,053,539    | Active  |
| Stable Return Fund Plan-XIV   | 28-Oct-24  | 09-Jan-25 | Low          | NA               | Matured |
| Stable Return Fund Plan-XV    | 19-Nov-24  | 14-Nov-25 | Low          | 1,737,391,742    | Active  |
| Stable Return Fund Plan-XVI   | 13-Dec-24  | 13-Jun-25 | Low          | 1,415,516,616    | Active  |
| Stable Return Fund Plan-XVII  | 27-Feb-25  | 27-Jun-25 | Low          | 7,496,935,341    | Active  |
| Stable Return Fund Plan-XVIII | 28-Feb-25  | 09-Jan-26 | Low          | 1,551,304,730    | Active  |
| Stable Return Fund Plan-XIX   | 14-Mar-25  | 05-Sep-25 | Low          | 1,025,590,776    | Active  |
| Stable Return Fund Plan-XX    | 16-May-25  | 06-May-28 | Low          | 5,260,540,910    | Active  |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 3,042.2 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 3,042.2 |
| NAV (PkR)                                         | 115.25  |
...
| ---------------------- | ------ | ------ |
| Since Inception Return | 15.66% | 18.63% |
| YTD                    | 15.20% | 16.27% |
| Month (May 2025)       | 16.94% | 22.91% |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating    | Percentage |
| ---------------------------- | ---------- | --------- | ---------- |
| Govt. Securities (Rated AAA) | 98.72%     | A         | 0.00%      |
| AAA                          | 0.23%      | A-        | 0.00%      |
| AA+                          | 0.00%      | BBB+      | 0.00%      |
| AA                           | 0.00%      | BBB       | 0.00%      |
| AA-                          | 0.00%      | Below IG  | 0.00%      |
| A+                           | 0.00%      | NR/UR/MTS | 1.05%      |
...
\*This includes 0.14% representing government levy and SECP Fee
\*\*Actual Management fee charged: 0.00% of net assets
Selling & marketing expense - for the period ended May, 2025, PKR Mn 0.000
...
| Fund Size (PkR mn; as on May 31, 2025)            | 5,447.1 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 5,447.1 |
| NAV (PkR)                                         | 108.83  |
...
| ---------------------- | ------ | ------- |
| Since Inception Return | 14.52% | 14.02%  |
| YTD                    | 14.52% | 14.02%  |
| Month (May 2025)       | 13.77% | 14.61%  |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating    | Percentage |
| ---------------------------- | ---------- | --------- | ---------- |
| Govt. Securities (Rated AAA) | 99.86%     | A         | 0.00%      |
| AAA                          | 0.01%      | A-        | 0.00%      |
| AA+                          | 0.00%      | BBB+      | 0.00%      |
| AA                           | 0.00%      | BBB       | 0.00%      |
| AA-                          | 0.00%      | Below IG  | 0.00%      |
| A+                           | 0.00%      | NR/UR/MTS | 0.13%      |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 4,341.1 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 4,341.1 |
| NAV (PkR)                                         | 108.30  |
...
| ---------------------- | ------ | ------- |
| Since Inception Return | 14.60% | 13.58%  |
| YTD                    | 14.60% | 13.58%  |
| Month (May 2025)       | 13.90% | 12.22%  |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating    | Percentage |
| ---------------------------- | ---------- | --------- | ---------- |
| Govt. Securities (Rated AAA) | 99.72%     | A         | 0.00%      |
| AAA                          | 0.27%      | A-        | 0.00%      |
| AA+                          | 0.00%      | BBB+      | 0.00%      |
| AA                           | 0.00%      | BBB       | 0.00%      |
| AA-                          | 0.00%      | Below IG  | 0.00%      |
...
\*This includes 0.19% representing government levy and SECP Fee
...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------- |
| Fund Type:               | Open Ended                                                                                                       |
| New Benchmark:           | Average deposit rate of comparable period of the Plan, of three (3)-AA rated Scheduled Bank as selected by MUFAP |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 1,737.4 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,737.4 |
| NAV (PkR)                                         | 107.21  |
...
| ---------------------- | ------ | ------- |
| Since Inception Return | 13.72% | 13.56%  |
| YTD                    | 13.72% | 13.56%  |
| Month (May 2025)       | 13.15% | 15.70%  |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating    | Percentage |
| ---------------------------- | ---------- | --------- | ---------- |
| Govt. Securities (Rated AAA) | 99.89%     | A         | 0.00%      |
| AAA                          | 0.11%      | A-        | 0.00%      |
| AA+                          | 0.00%      | BBB+      | 0.00%      |
| AA                           | 0.00%      | BBB       | 0.00%      |
| AA-                          | 0.00%      | Below IG  | 0.00%      |
...
| Fund    | May-24 | Jun-24 | Jul-24 | Aug-24 | Sep-24 | Oct-24 | Nov-24 | Dec-24 | Jan-25 | Feb-25 | Mar-25 | Apr-25 | May-25 |
| ------- | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| ASRF-15 | -      | -      | -      | -      | -      | -      | -      | -      | 14.54% | 9.02%  | 8.63%  | 11.35% | 15.70% |
| BM      | -      | -      | -      | -      | -      | -      | -      | -      | 13.15% | 13.15% | 13.15% | 13.15% | 13.15% |
...
\*This includes 0.12% representing government levy and SECP Fee
\*\*Actual Management fee charged: 0.28% of net assets
Selling & marketing expense - for the period ended May, 2025, PKR Mn 0.000
...
| Fund Size (PkR mn; as on May 31, 2025)            | 1,415.5 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,415.5 |
| NAV (PkR)                                         | 105.35  |
...
| ---------------------- | ------ | ------- |
| Since Inception Return | 12.24% | 11.48%  |
| YTD                    | 12.24% | 11.48%  |
| Month (May 2025)       | 11.90% | 12.16%  |

Credit Quality (as % of Total Assets)

| Rating                       | Percentage | Rating    | Percentage |
| ---------------------------- | ---------- | --------- | ---------- |
| Govt. Securities (Rated AAA) | 99.71%     | A         | 0.00%      |
| AAA                          | 0.28%      | A-        | 0.00%      |
| AA+                          | 0.00%      | BBB+      | 0.00%      |
| AA                           | 0.00%      | BBB       | 0.00%      |
| AA-                          | 0.00%      | Below IG  | 0.00%      |
| A+                           | 0.00%      | NR/UR/MTS | 0.01%      |
...
\*This includes 0.130% representing government levy and SECP Fee
\*\*Actual Management fee charged: 0.1% of net assets
Selling & marketing expense - for the period ended May, 2025, PKR Mn 0.000

Alfalah Asset Management Ltd. (formerly Alfalah GHP Investment Management Limited)
Fund Managers' Report May 31, 2025

# Alfalah Stable Return Fund - Plan 17
...
| Fund Size (PkR mn; as on May 31, 2025)            | 7,496.9 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 7,496.9 |
| NAV (PkR)                                         | 102.90  |
...
| ---------------------- | ------ | ------- |
| Since Inception Return | 11.79% | 11.40%  |
| YTD                    | 11.79% | 11.40%  |
| Month (May 2025)       | 11.79% | 12.20%  |

Credit Quality (as % of Total Assets)

| Investment Grade       | Value  | Non-Investment Grade | Value |
| ---------------------- | ------ | -------------------- | ----- |
| Govt. Securities (AAA) | 99.90% | A                    | 0.00% |
| AAA                    | 0.10%  | A-                   | 0.00% |
| AA+                    | 0.00%  | BBB+                 | 0.00% |
| AA                     | 0.00%  | BBB                  | 0.00% |
| AA-                    | 0.00%  | Below IG             | 0.00% |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 1,551.3 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,551.3 |
| NAV (PkR)                                         | 103.06  |
| Wtd. Average Maturity (Years)                     | 0.61    |
| Total Expense Ratio (YTD)\*                       | 0.49%   |
| Total Expense Ratio (Month)                       | 0.48%   |

Fund Performance

| Fund Performance       | BM     | ASRF-18 |
| ---------------------- | ------ | ------- |
| Since Inception Return | 11.63% | 12.01%  |
| YTD                    | 11.63% | 12.01%  |
| Month (May 2025)       | 11.63% | 16.73%  |

Credit Quality (as % of Total Assets)

| Investment Grade       | Value  | Speculative Grade      | Value |
| ---------------------- | ------ | ---------------------- | ----- |
| Govt. Securities (AAA) | 99.60% | A                      | 0.00% |
| AAA                    | 0.39%  | A-                     | 0.00% |
| AA+                    | 0.00%  | BBB+                   | 0.00% |
| AA                     | 0.00%  | BBB                    | 0.00% |
| AA-                    | 0.00%  | Below Investment Grade | 0.00% |
| A+                     | 0.00%  | NR/UR/MTS              | 0.02% |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 1,025.6 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,025.6 |
| NAV (PkR)                                         | 102.56  |
...
| Fund Performance       | BM     | ASRF-19 |
| ---------------------- | ------ | ------- |
| Since Inception Return | 11.81% | 11.82%  |
| YTD                    | 11.81% | 11.82%  |
| Month (May 2025)       | 11.81% | 13.73%  |

Credit Quality (as % of Total Assets)

| Investment Grade Assets     | Weight | Non-Investment Grade Assets | Weight |
| --------------------------- | ------ | --------------------------- | ------ |
| Government Securities (AAA) | 99.93% | A                           | 0.00%  |
| AAA                         | 0.04%  | A-                          | 0.00%  |
| AA+                         | 0.00%  | BBB+                        | 0.00%  |
| AA                          | 0.00%  | BBB                         | 0.00%  |
| AA-                         | 0.00%  | Below Investment Grade      | 0.00%  |
| A+                          | 0.00%  | Not Rated/Unrated/MTS       | 0.02%  |
...
| Fund Size (PkR mn; as on May 31, 2025)            | 5,260.5 |
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 5,260.5 |
| NAV (PkR)                                         | 100.93  |
| Wtd. Average Maturity (Years)                     | 1.35    |
...
| Fund Performance       | BM     | ASRF-20 |
| ---------------------- | ------ | ------- |
| Since Inception Return | 11.41% | 22.71%  |
| YTD                    | 11.41% | 22.71%  |
| Month (May 2025)       | 11.41% | 22.71%  |

Credit Quality (as % of Total Assets)

| Investment Grade | Weight | Speculative Grade | Weight    |
| ---------------- | ------ | ----------------- | --------- |
| Government (AAA) | 95.17% | A                 | 0.00%     |
| AAA Corporate    | 4.35%  | A-                | 0.00%     |
| AA+              | 0.00%  | BBB+              | 0.00%     |
| AA               | 0.00%  | BBB               | 0.00%     |
| AA-              | 0.00%  | Below IG          | 0.00%     |
| A+               | 0.00%  | **NR/UR**         | **0.49%** |
...
# Investment Plans Summary Report for May 2025 ( Alfalah Prosperity Planning Fund)
...
| Cumulative Net Assets (CIS)                         | PKR 1,042,996,974                |
| Risk Profile (CIS)                                  | Low                              |
...
| Rating Fee                  | 13,974       |
| Formation Cost Amortization | -            |
| Other Expenses              | 213,926      |

Investment Plans Overview

| Investment Plan Name                                          | Date of Launch | Maturity Date | Risk Profile | Net Assets (PKR) | Status |
| ------------------------------------------------------------- | -------------- | ------------- | ------------ | ---------------- | ------ |
| Alfalah Prosperity Planning Fund-Moderate Allocation Plan     | 11-Sept-2015   | Perpetual     | Medium       | 57,202,665       | Active |
| Alfalah Prosperity Planning Fund-Active Allocation Plan-II    | 11-Sept-2015   | Perpetual     | High         | 113,964,363      | Active |
| Alfalah Prosperity Planning Fund-Conservative Allocation Plan | 11-Sept-2015   | Perpetual     | Medium       | 329,536,708      | Active |
| Alfalah Prosperity Planning Fund-Capital Preservation Plan    | 16-May-2024    | 16-May-2026   | High         | 542,293,236      | Active |
...
Alfalah GHP Prosperity Planning Fund is an Open-ended Fund of Funds Scheme that aims to generate returns on investment as per the respective Allocation Plan by investing in Collective Investment Schemes in line with the risk tolerance of the investor.
...
| Period             | Benchmark (BM) | Fund (AGAAP) |
| ------------------ | -------------- | ------------ |
| Since Inception    | 15.37%         | 13.46%       |
| Year-to-Date (YTD) | 48.30%         | 56.21%       |
| April 2025         | 8.17%          | 6.27%        |
...
| Period             | Benchmark (BM) | Fund (AGMAP) |
| ------------------ | -------------: | -----------: |
| Since Inception    |         13.92% |       12.00% |
| Year-to-Date (YTD) |         30.17% |       33.16% |
| April 2025         |          3.16% |        2.92% |
...
| Period             | Benchmark (BM) | Fund (AGCAP) |
| ------------------ | -------------: | -----------: |
| Since Inception    |         12.90% |       11.61% |
| Year-to-Date (YTD) |         20.45% |        2.86% |
| April 2025         |          2.40% |        2.16% |

Alfalah GHP Capital Preservation Plan
...
| **Cash**             |   0.04% |   0.09% |
| **Equity**           |   0.07% |   0.17% |
| **Sovereign/Income** |  44.32% |  45.39% |
| **Money Market**     |  45.81% |  44.76% |
| **Others**           |   9.76% |   9.60% |
| **Total**            | 100.00% | 100.00% |
...
| Period             | Benchmark (BM) | Fund (AGCAP) |
| ------------------ | -------------: | -----------: |
| Since Inception    |         30.69% |       34.35% |
| Year-to-Date (YTD) |         27.17% |       30.75% |
| April 2025         |          4.25% |        3.79% |
...
| Plan Name | Fund Name                            | Type of Breach  | Value Before Provisioning | Provisioning Held | Value After Provisioning | Current Exposure | Regulatory Limit |
| --------- | ------------------------------------ | --------------- | ------------------------: | ----------------: | -----------------------: | ---------------: | ---------------: |
| AGPPF-MAP | Alfalah GHP Prosperity Planning Fund | [Not Specified] |                    47.04% |               50% |                    [N/A] |            [N/A] |            [N/A] |
...
\*\*\* AGMAP: This include 0.1000% representing government levy and SECP Fee
\*\*\*\* AGCAP: This include 0.0900% representing government levy and SECP Fee
\*\*\*\* AGCPP4: This include 0.1000% representing government levy and SECP Fee
\*\*\*\* Actual Management fee charged for AGAAP: 0.00% of net assets
\*\*\*\* Actual Management fee charged for AGCAP: 0.01% of net assets
\*\*\*\* Actual Management fee charged for AGMAP: 0.23% of net assets
...
# Investment Plans Summary Report for May 2025 (Alfalah Pension Fund)
...
| Cumulative Net Assets (CIS)                         | PKR 703,570,944      |
| Risk Profile (CIS)                                  | Low                  |
...
| Rating Fee                  | -            |
| Formation Cost Amortization | -            |
| Other Expenses              | 1,194,398    |

Investment Plans Overview

| Investment Plan Name   | Date of Launch | Maturity Date | Risk Profile | Net Assets (PKR) | Status |
| ---------------------- | -------------- | ------------- | ------------ | ---------------- | ------ |
| Pension - Equity       | 8-Nov-2016     | Perpetual     | High         | 184,779,754      | Active |
| Pension - Debt         | 8-Nov-2016     | Perpetual     | Medium       | 140,903,821      | Active |
| Pension - Money Market | 8-Nov-2016     | Perpetual     | Low          | 377,887,369      | Active |

# Alfalah KPK Employee Pension Fund

Fund Stability Rating: Not Yet Rated

AMC Rating: "AM1" by VIS 02-Jan-25, "AM1" by PACRA 30-August-24
...
| Fund Size (PKR Mn)        | 41.5483 |
| ------------------------- | ------- |
| NAV (PKR)                 | 125.071 |
| Year To Date Return       | 13.62%  |
| Since Inception Return\*  | 17.14%  |
...
**AKPKMMSF**: Alfalah KPK Employee Pension Fund - Money Market Sub Fund
Alfalah Asset Management Ltd. (formerly Alfalah GHP Investment Management Limited)
...
| ------------------------------------- | ---------- |
| Haleon Pakistan Limited               | 8.69%      |
| United Bank Limited                   | 8.32%      |
| Fauji Fertilizer Company Limited      | 6.30%      |
| Pakistan State Oil Company Limited    | 5.81%      |
| Oil & Gas Development Company Limited | 4.48%      |
| Mari Petroleum Company Limited        | 4.33%      |
| Lucky Cement Limited                  | 4.15%      |
| Pakistan Petroleum Limited            | 3.76%      |
| Sazgar Engineering Works Limited      | 3.68%      |
...
| Sector                          | Percentage |
| ------------------------------- | ---------- |
| Commercial Banks                | 22.74%     |
| Cement                          | 16.29%     |
| Oil & Gas Exploration Companies | 12.57%     |
| Pharmaceuticals                 | 11.96%     |
| Oil & Gas Marketing Companies   | 7.37%      |
| Others                          | 25.50%     |

Fund Statistics

| Fund Size (PKR Mn.)       | 184.78 |
| ------------------------- | ------ |
| NAV                       | 241.35 |
| Year To Date Return       | 56.41% |
| Since Inception Return\*  | 11.04% |
| Expense ratio (month)     | 4.52%  |
| Expense ratio (YTD)\*\*\* | 4.55%  |

Alfalah GHP Debt Sub Fund

Fund Statistics

| Fund Size (PKR Mn.)         | 140.904 |
| --------------------------- | ------- |
| NAV                         | 228.30  |
| Year To Date Return         | 19.21%  |
| Since Inception Return\*    | 10.31%  |
| Expense ratio (month)       | 1.90%   |
| Expense ratio (YTD)\*\*\*\* | 1.60%   |

Alfalah GHP Money Market Sub Fund

Fund Statistics

| Fund Size (PKR Mn.)       | 377.89 |
| ------------------------- | ------ |
| NAV                       | 231.95 |
| Year To Date Return       | 14.55% |
| Since Inception Return\*  | 10.52% |
| Expense ratio (month)     | 1.00%  |
| Expense ratio (YTD)**\*** | 1.05%  |

Alfalah GHP Money Market Fund - Non-Compliant Investments

| Fund Name   | Type         | Apr-24 | May-24 | Jun-24 | Jul-24 | Aug-24 | Sep-24 | Oct-24 | Nov-24 | Dec-24 | Jan-25 | Feb-25 | Mar-25 | Apr-25 | May-25 |
| ----------- | ------------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| **AGPESF**  | Equity       | 7.54%  | 5.57%  | 5.12%  | 0.24%  | 1.82%  | 3.77%  | 11.70% | 14.74% | 12.82% | -2.06% | 0.50%  | 3.20%  | -4.95% | 5.78%  |
| **AGPDSF**  | Debt         | 17.72% | 17.27% | 13.69% | 19.81% | 18.33% | 35.14% | 14.66% | 22.53% | 8.86%  | 12.07% | 11.19% | 11.11% | 12.10% | 30.39% |
| **AGPMMSF** | Money Market | 19.96% | 19.75% | 25.70% | 19.36% | 18.00% | 19.80% | 16.72% | 13.67% | 12.20% | 9.43%  | 9.96%  | 9.51%  | 10.18% | 12.05% |
...
\*\* Actual Management fee charged: 0.56% of net assets for Debt, 0.49% for Money market sub funds and 3.28% of net assets for Equity sub fund

\*\*\* AGESF: This includes 0.5900% representing government levy and SECP Fee

\*\*\*\* AGDSF: This includes 0.1600% representing government levy and SECP Fee

\*\*\*\*\* AGMMSF: This includes 0.1400% representing government levy and SECP Fee
...
| Fund Size (PKR Mn.)       | 1.26   |
| ------------------------- | ------ |
| NAV                       | 240.49 |
| MTD Return                | -0.13% |
| Year To Date Return       | 38.95% |
| Since Inception Return\*  | 27.14% |
| Expense Ratio (Month)     | 4.35%  |
| Expense Ratio (YTD)\*\*\* | 2.31%  |

### Alfalah GHP Debt Sub Fund

| Fund Size (PKR Mn.)         | 2.150  |
| --------------------------- | ------ |
| NAV                         | 162.35 |
| MTD Return                  | 11.66% |
| Year To Date Return         | 14.34% |
| Since Inception Return\*    | 14.18% |
| Expense Ratio (Month)       | 2.41%  |
| Expense Ratio (YTD)\*\*\*\* | 1.20%  |

### Alfalah GHP Money Market Sub Fund

| Fund Size (PKR Mn.)       | 8.71   |
| ------------------------- | ------ |
| NAV                       | 167.15 |
| MTD Return                | 14.61% |
| Year To Date Return       | 15.44% |
| Since Inception Return\*  | 15.09% |
| Expense Ratio (Month)     | 1.25%  |
| Expense Ratio (YTD)**\*** | 1.01%  |
...
\*\*\* AGESF: This includes 0.1400% representing government levy and SECP Fee

\*\*\*\* AGDSF: This includes 0.0600% representing government levy and SECP Fee

\*\*\*\*\* AGMMSF: This includes 0.0600% representing government levy and SECP Fee
...
| Fund Size (PkR mn; as on Mar 31, 2025)            | 5,423 |
| ------------------------------------------------- | ----- |
| Fund size including fund of fund schemes (PkR mn) | 5,423 |
| NAV (PkR)                                         | 107.1 |
...
| Fund Performance         | BM     | AGSOF  |
| ------------------------ | ------ | ------ |
| Since Inception Return\* | 13.02% | 15.71% |
| YTD                      | 13.02% | 15.71% |
| Month (March 2025) - New | 11.75% | 5.60%  |
| Month (March 2025) - Old | 11.80% | -      |

Avg. Peer Group Return for March 2025 was 7.04%
...
Selling & marketing expenses - for the period ended March 31, 2025: PKR 1.25 Mn
...
| ------------------------------------------------- | ------- |
| Fund size including fund of fund schemes (PkR mn) | 1,458.0 |
| NAV (PkR)                                         | 112.52  |
...
| ----------------------------- | ------ | ------- |
| Since Inception Return        | 18.21% | 18.92%  |
| YTD                           | 17.83% | 18.25%  |
...
| Credit Rating                | Percentage |
| ---------------------------- | ---------- |
| Govt. Securities (Rated AAA) | 99.70%     |
| A                            | 0.00%      |
| AAA                          | 0.00%      |
| A-                           | 0.00%      |
| AA+                          | 0.00%      |
...
\*This includes 0.310% representing government levy and SECP Fee
