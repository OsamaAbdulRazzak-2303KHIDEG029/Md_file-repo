...
| Pakistan Telecommunication Company Limited - SUKUK X           | 1.74% |
| -------------------------------------------------------------- | ----- |
...
| Fund Size (PkR mn; as on Jan 31, 2025):            | 10,016 |
| -------------------------------------------------- | ------ |
...
Islamic Moderate Allocation Plan (AGIMAP) (Monthly Returns)
...
- **\***This includes 0.1800% representing government levy and SECP Fee.
  **\*AGIPESF: This includes 0.5500% representing government levy and SECP Fee
...
The objective of the Alfalah Islamic KPK Employee Pension Fund is to provide employees with an individualized, funded (based on defined contribution) as well as flexible pension scheme which is managed by professional investment managers to assist them in planning and providing for their retirement. The design of the allocation scheme empowers the employees to invest their pensions as per their desired asset allocations.
...
| Fund Size (PKR Mn; as on Jan 2025): | 56.93  |
| ----------------------------------- | ------ |
| NAV (PKR):                          | 118.33 |
| Year To Date Return:                | 14.20% |
| Since Inception Return\*:           | 16.16% |
...
| --------- | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| AIKPKMMSF | 9.82%  | 17.96% | 17.10% | 20.81% | 14.40% | 11.63% | 17.71% | 17.88% | 16.66% | 13.76% | 11.60% | 14.34% | 4.17%  |
